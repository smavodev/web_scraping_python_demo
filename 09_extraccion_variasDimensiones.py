...
class IGNCrawler(CrawlSpider):
    ...
    def parse_review(self, response):
        ...
        item.add_xpath('calificacion',
                       '//div[@class="review"]//span[@class="side-wrapper side-wrapper hexagon-content"]/text()')
    ...
    def parse_news(self, response):
        ...
        item.add_xpath('titulo', '//h1/text()')
        item.add_xpath('contenido', '//div[@id="id_text"]/p/text()')  # //div[@id="id_text"]//*/text()
        yield item.load_item()

# scrapy runspider 09_extraccion_variasDimensiones.py -o ign.json -t json