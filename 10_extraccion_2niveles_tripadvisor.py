...
class TripAdvisor(CrawlSpider):
    ...
    def parse_opinion(self, response):
        ...
        for opinion in opiniones:
            ...
            item.add_xpath('calificacion', './/div[contains(@class, "ui_card section")]//a/div/span[contains(@class, "ui_bubble_rating")]/@class',
                           MapCompose(lambda i: i.split('_')[-1]))
            yield item.load_item()

# EJECUCION
# scrapy runspider 10_extraccion_2niveles_tripadvisor.py -o tripadvisor_users.csv -t csv
